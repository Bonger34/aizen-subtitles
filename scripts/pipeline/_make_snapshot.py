...
BASE = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'docs')
...
# 必须有这个保护: 此前整个脚本在模块级执行, 任何 import 它的工具(如批量体检脚本)
# 都会顺手在 docs/ 下写出一份 _snapshot.html —— 已实际发生过一次。
